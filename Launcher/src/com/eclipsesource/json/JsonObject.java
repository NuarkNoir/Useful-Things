...
public class JsonObject extends JsonValue implements Iterable {
   ...
   public JsonObject merge(JsonObject object) {
      if (object == null) {
         ...
         for(Object member : object) {
            this.set(((JsonObject.Member)member).name, ((JsonObject.Member)member).value);
         }
   ...
   public Iterator iterator() {
      final Iterator namesIterator = this.names.iterator();
      final Iterator valuesIterator = this.values.iterator();
      return new Iterator() {
   ...
   void write(JsonWriter writer) throws IOException {
      ...
      for(boolean first = true; namesIterator.hasNext(); first = false) {
         if (!first) {
   ...
   static class HashIndexTable {
      ...
      public HashIndexTable(JsonObject.HashIndexTable original) {
   ...
   public static class Member {
      ...
      public boolean equals(Object obj) {
         if (this == obj) {
            ...
            JsonObject.Member other = (JsonObject.Member)obj;
